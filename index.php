...
//INSERT INTO `notes` (`srno`, `title`, `description`, `tstamp`) VALUES ('1', 'book', 'this is my book.', current_timestamp());
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($result) {
    ...
    echo "Record insert unsuccessfull" . mysqli_error($conn);
  }
}
}
?>
...
<body>
  ...
  if ($insert) {
    ...
    <strong>Holy guacamole!</strong> Your note has been added.
  ...
  if($update){
    echo'<div class="alert alert-success alert-dismissible fade show" role="alert">
    <strong>Holy guacamole!</strong> Your note has been updated.
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
  }
  ?>
  ...
  if($delete){
    ...
    <strong>Holy guacamole!</strong> Your note has been deleted.
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
  }
  ?>
